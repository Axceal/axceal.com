...
export function BatteryIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      ...
      style={style}
    >
      {/* Battery body fill — matches the gray body visible behind the bolt */}
      <rect x="2" y="1" width="28" height="27" fill="currentColor" />
      ...
      <path
        d="M21.5445 7.71484L16.4438 14.6828H23.1153L19.4758 21.3108"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
